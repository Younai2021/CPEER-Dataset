...
__Note:__ The English version is generated by ChatGPT and proofread manually but it may still contain inaccurate information. 
...
经过我们的讨论，我们最终决定数据集的列名如下（下表数据仅供展示，非真实数据）：  
